    ...
    if (props.invalid && props.touched){
        ...
        switch (props.name) {
            ...
            case('street'):
                ...
                break;
            case('zipCode'):
                validationError = <p>Please enter a 5 digit zip code</p>;
                break;
            case('county'):
            ...
            case('deliveryMethod'):
                ...
                break;
            case('password'):
                validationError = <p>Please ensure your password is at least six characters long</p>;
                break;
            case('confirmPassword'):
                validationError = <p>Passwords do not match</p>;
                break;
            default:
